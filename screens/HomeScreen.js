...
import { fetchWeatherApi, locationApi } from "../api/weather";
...
export default function HomeScreen() {
  ...
  const handelTextDebounce = useCallback(debounce(handelSearch, 300), []);
  const { current, location, city_name } = weather;
