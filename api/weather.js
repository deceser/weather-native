...
const historyEndPoint = params =>
  `http://api.weatherapi.com/v1/history.json?key=${apiKey}&q=${params.cityName}&dt=${params.date}`;

const futureEndPoint = params =>
  `http://api.weatherapi.com/v1/future.json?key=${apiKey}&q=${params.cityName}&dt=${params.date}`;

const marineEndPoint = params =>
  `http://api.weatherapi.com/v1/marine.json?key=${apiKey}&q=${params.cityName}&days=${params.days}`;
